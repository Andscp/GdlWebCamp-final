                ...
                <div class="caja">
                    ...
                    <?php 
                        foreach ($eventos_dias as $dia => $eventos) { ?>
                            ...
                            <div id="<?php echo str_replace('á', 'a', $dia); ?>" class="contenido-dia fondo-dia  clearfix">
                                <h4><?php echo $dia; ?></h4>

                                <?php 
                                    foreach ($eventos['eventos'] as $tipo => $evento_dia):?>
                                <div>
                                    <p style="font-weight: bold;"><?php echo $tipo; ?></p>
                                    ...
                                    <?php foreach ($evento_dia as $evento) {?>     
                                        <label>
                                            ...
                                            <br>
                                            <span style="margin-left: 29px; font-size: .9em;">Por: </span>
